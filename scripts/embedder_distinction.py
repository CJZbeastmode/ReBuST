...
def run(
    ...
    embedder = Embedder(img_backend=embedder_type)
    score_type = "textalign"

    wsi = WSI(image_path, embedder=embedder)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="conch",
        choices=["plip", "conch"],
        help="Embedder type to visualise (default: plip)",
    )
    parser.add_argument(
        "--neg-types",
        type=str,
    ...
    run(
        ...
        output_html=f"data/visualizations/embedder_distinction/{args.embedder_type}.html",
...
# PLIP
# [INFO] Overall score stats — min=26.0000  max=46.0000  mean=34.6942
# [DONE] Saved → data/visualizations/embedder_distinction/plip.html
# [TOTAL TIME] 71.6 seconds

# CONCH
# [INFO] Overall score stats — min=-0.0805  max=0.1299  mean=0.0057
# [DONE] Saved → data/visualizations/embedder_distinction/conch.html
