...
classes = ['CHOL', 'COAD', 'ESCA', 'LIHC', 'LUAD', 'LUSC',
...
legend_elements = [
    ...
    mpatches.Patch(facecolor='#dbeafe', edgecolor='#2e86c1', linewidth=1.5,
                   label='ST (proposed)'),
]
ax.legend(handles=legend_elements, loc='upper right',
          bbox_to_anchor=(1.42, 1.02), frameon=False, fontsize=9)

plt.tight_layout(pad=2)
plt.savefig('ablation_classifier_heatmap.png', dpi=180, bbox_inches='tight', facecolor='white')
plt.show()