...
acc     = [0.5000, 0.4615, 0.6667, 0.5833, 0.7500, 0.6000,
           0.6667, 0.6667, 0.3333, 0.7143, 0.3846, 0.3333]
...
bars = ax.barh(y_pos, acc_s, height=0.62, color=colors,
...
ax.axvline(mean_acc, color='#888888', linewidth=1.2,
           linestyle='--', zorder=4, alpha=0.8)
ax.text(mean_acc + 0.005, -0.7, f'mean = {mean_acc:.3f}',
...
legend_elements = [Patch(facecolor='#2e86c1', label='Common class'),
                   Patch(facecolor='#e67e22', label='Rare class')]
ax.legend(handles=legend_elements, loc='upper right',
          frameon=False, fontsize=9.5)

plt.tight_layout(pad=2)
plt.savefig('rebust_perclass.png', dpi=180, bbox_inches='tight',
            facecolor='white')
plt.show()