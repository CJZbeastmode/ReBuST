...
def run_pipeline(
    ...
    out_global: str = DEFAULT_OUT_GLOBAL,
    out_local: str = DEFAULT_OUT_LOCAL,
    ...
    score_key     : str   Key into PATCH_SCORE_MODULES for HUMBE scoring.
    min_level     : int   Finest pyramid level A2C/HUMBE may zoom into
                          (default 2 — avoids native full-resolution level 0).
    out_humbe     : str   HTML visualization path after HUMBE.
    ...
    wsi = WSI(image_path, min_level=min_level, multistage=True)
