...
def a2c_update(model, optimizer, trajectory, gamma=GAMMA, gae_lambda=GAE_LAMBDA, entropy_beta=ENTROPY_BETA, value_coef=VALUE_COEF):
    """
...
def train_a2c(
    ...
    output_dir='data/models/rl/a2c_lvl4',
    device=None,
    ...
    print(f"Training A2C Level 4 (Multi-Step Returns with GAE - FIXED) on device: {device}")
    print(f"Raw state: 1033-D → Projected: 585-D | Hidden: 512 | Entropy beta: {ENTROPY_BETA}")
