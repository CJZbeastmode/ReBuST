...
def train_a2c(
    ...
    print(
        f"neg_types={neg_types} | GAE lambda: {gae_lambda} | Redundancy penalty: {redundancy_penalty}"
    )
    ...
    for epoch in range(num_epochs):
        ...
        for img_path in image_paths:
            ...
            try:
                ...
                print(
                    f"[INFO] {img_name}  cancer_type={cancer_type}  "
                ...
                env.patch_score_module = (
                    scorer  # override with per-image contrastive scorer
                )
...
def main():
    ...
    parser.add_argument(
        "--output-dir", type=str, default="data/models/rl/a2c_lvl4_contrastive"
    )
    parser.add_argument(
