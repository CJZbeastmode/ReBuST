...
def train_a2c(
    ...
    output_dir='data/models/rl/a2c_lvl4_centroid',
    device=None,
    redundancy_penalty=REDUNDANCY_PENALTY,
    overlap_threshold=OVERLAP_THRESHOLD,
    ...
    for epoch in range(num_epochs):
        ...
        for img_path in image_paths:
            ...
            try:
                ...
                env.patch_score_module = scorer   # override with per-image centroid scorer
...
def main():
    ...
    parser.add_argument('--output-dir', type=str,
                        default='data/models/rl/a2c_lvl4_centroid')
