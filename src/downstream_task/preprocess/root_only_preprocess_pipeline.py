"""Extract only root-level patches for all slides in a directory."""
...
DEFAULT_OUTPUT_DIR = "/Volumes/Xbox_HD/Data/extracted/root/train"
...
def main(args) -> None:
    ...
    for case_id in tqdm(sorted(cases.keys()), desc="root_only_preprocess"):
...
if __name__ == "__main__":
    p = argparse.ArgumentParser(description="Extract root-level patches only")
