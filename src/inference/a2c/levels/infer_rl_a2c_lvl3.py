...
def greedy_infer_a2c(
    ...
    print(f"[VISIT] lvl={level} x={x} y={y} depth={max_depth} has_parent={history.has_parent}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Inference with A2C Level 3 (Contextual Memory)")
    parser.add_argument("--image", type=str, default="data/to_test_image/test_img_1.svs")
    parser.add_argument("--model", type=str, default="data/models/rl/a2c_lvl3/a2c_lvl3_final.pt")
    parser.add_argument("--output-viz-path", type=str, default="data/visualizations/rl/a2c/viz_a2c_lvl3.html")
