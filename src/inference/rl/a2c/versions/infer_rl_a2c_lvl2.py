...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Inference with A2C Level 2 (Redundancy Avoidance)"
    )
    parser.add_argument(
        "--image", type=str, default="data/to_test_image/test_img_1.svs"
    )
    parser.add_argument(
        "--model", type=str, default="data/models/rl/a2c_lvl2/a2c_lvl2_final.pt"
    )
    parser.add_argument(
        "--output-viz-path",
        type=str,
        default="data/visualizations/rl/a2c/viz_a2c_lvl2.html",
    )
